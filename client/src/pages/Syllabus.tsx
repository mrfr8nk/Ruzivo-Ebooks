...
export default function Syllabus() {
  ...
  const syllabusDocuments = books.filter(book => book.bookType === "Syllabus");
  const filteredBooks = syllabusDocuments.filter(book =>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Access ZIMSEC syllabus documents for all subjects
          </p>
        </div>
        ...
        {isLoading ? (
          <div className="text-center py-12">
            <p className="text-muted-foreground">Loading syllabus documents...</p>
          </div>
        ) : filteredBooks.length === 0 ? (
          <Card className="p-12 text-center">
            <p className="text-muted-foreground">No syllabus documents found.</p>
          </Card>
        ) : (
