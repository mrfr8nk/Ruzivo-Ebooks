...
export default function OLevel() {
  ...
  const oLevelBooks = books.filter(book => book.level === "O-Level");
  const filteredBooks = oLevelBooks.filter(book =>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Access comprehensive O-Level study materials for all ZIMSEC subjects
          </p>
        </div>
        ...
        <div className="mb-8">
          <div className="relative max-w-2xl mx-auto">
            ...
            <Input
              type="text"
              placeholder="Search O-Level materials..."
              value={searchTerm}
        ...
        {isLoading ? (
          ...
          <Card className="p-12 text-center">
            <p className="text-muted-foreground">No O-Level materials found.</p>
          </Card>
        ) : (
