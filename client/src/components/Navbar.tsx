        ...
        <div className="flex items-center justify-between h-20 gap-4">
          ...
          <div className="hidden md:flex items-center gap-4 flex-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                className="text-sky-200 hover:text-white hover:bg-white/10 transition-all duration-300 rounded-xl border border-sky-400/30"
          ...
          <div className="md:hidden flex items-center gap-2">
            <Button
              ...
              variant="ghost"
              onClick={toggleDarkMode}
              className="text-sky-200 hover:text-white hover:bg-white/10 rounded-xl border border-sky-400/30"
